  ...
  return (
    <div class="countdown">
      <div class="flex flex-col w-20 sm:w-32 gap-4">
        <div class="text-4xl sm:text-7xl flex flex-col gap-[1px] after:box-border before:box-border relative" style={{color: 'hsl(345, 95%, 68%)', boxShadow: '0 13px 0 0 black'}}>
          <div class="px-4 py-6 rounded-md rounded-b-none" style={{backgroundColor: 'hsl(236, 21%, 26%)'}}>{props.countDown}</div>
